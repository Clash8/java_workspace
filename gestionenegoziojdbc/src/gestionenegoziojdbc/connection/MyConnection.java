package gestionenegoziojdbc.connection;
...
public class MyConnection {
	...
	private static final String CONNECT_STR = "jdbc:mysql://localhost:3306/java?user=root&password=root&allowPublicKeyRetrieval=true&useSSL=FALSE&serverTimezone=UTC";
