...
<html lang="it" class="h-100" >
	...
	<title>Modifica satellite con id ${edit_satellite_attr.id}</title>
	 </head>
					...
					<div class="alert alert-info alert-dismissible fade show d-none" role="alert">
					  ...
					  <div class='card'>
						    <div class='card-header'>
						        <h5>Modifica satellite con id: ${edit_satellite_attr.id}</h5>
						    </div>
						    <div class='card-body'>
									...
									<form:form modelAttribute="edit_satellite_attr" method="post" action="edit" class="row g-3" novalidate="novalidate">
