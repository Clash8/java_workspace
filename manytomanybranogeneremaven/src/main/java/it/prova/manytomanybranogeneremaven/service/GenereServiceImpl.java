...
public class GenereServiceImpl implements GenereService {
	...
	@Override
	public List<Genere> listAllByBranoPubblicatoTraDueDate(LocalDate dataInizio, LocalDate dataFine) throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return genereDAO.listAllByBranoPubblicatoTraDueDate(dataInizio, dataFine);
