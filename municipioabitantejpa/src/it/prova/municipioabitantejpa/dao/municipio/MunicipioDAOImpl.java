...
public class MunicipioDAOImpl implements MunicipioDAO {
	...
	public List<Municipio> findAllByAbitantiMinorenni() throws Exception {
		return entityManager.createQuery(
						"select distinct m from Municipio m join m.abitanti a  where a.eta < 18", Municipio.class)
				.getResultList();
	}

	@Override
	public List<Municipio> findAllByDescrizioneIniziaCon(String iniziale) throws Exception {
		TypedQuery<Municipio> query = entityManager.createQuery("from Municipio m where descrizione like ?1", Municipio.class);
