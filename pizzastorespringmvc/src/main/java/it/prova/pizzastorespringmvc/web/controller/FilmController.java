...
import it.prova.pizzastorespringmvc.dto.FilmDTO;
import it.prova.pizzastorespringmvc.dto.RegistaDTO;
import it.prova.pizzastorespringmvc.model.Film;
import it.prova.pizzastorespringmvc.service.FilmService;
...
public class FilmController {
	...
	public String delete(@PathVariable(required = true) Long idFilm, Model model, RedirectAttributes redirectAttrs) {
		model.addAttribute("delete_film_attr", filmService.caricaSingoloElemento(idFilm));

		if (model.getAttribute("delete_film_attr") == null) {
