							...
							<form:form modelAttribute="edit_cliente_attr"  method="post" action="${pageContext.request.contextPath }/cliente/update" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									...
									<spring:bind path="indirizzo">
										<input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" name="indirizzo" id="indirizzo" placeholder="Inserire l'indirizzo" value="${edit_cliente_attr.indirizzo }">
									</spring:bind>
									<form:errors  path="indirizzo" cssClass="error_field" />
								</div>

								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${edit_cliente_attr.dataDiNascita}' />
								<div class="col-md-3">
								...
								<div class="col-md-3">
									...
									<spring:bind path="attivo">
										<select class="form-select ${status.error ? 'is-invalid' : ''}" id="attivo" name="attivo">
											...
											<option value="true" ${edit_cliente_attr.attivo == 'true'?'selected':''} >Vero</option>
											<option value="false" ${edit_cliente_attr.attivo == 'false'?'selected':''} >Falso</option>
										</select>
									</spring:bind>
