							...
							<form:form modelAttribute="edit_pizza_attr"  method="post" action="${pageContext.request.contextPath }/pizza/update" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									...
									<spring:bind path="ingredienti">
										<input type="text" name="ingredienti" id="ingredienti" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il ingredienti" value="${edit_pizza_attr.ingredienti }">
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="prezzoBase">
										<input type="number" step="0.5" class="form-control ${status.error ? 'is-invalid' : ''}" name="prezzoBase" id="prezzoBase" placeholder="Inserire il prezzo base" value="${edit_pizza_attr.prezzoBase }">
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="attivo">
										<select class="form-select ${status.error ? 'is-invalid' : ''}" id="attivo" name="attivo">
											...
											<option value="true" ${edit_pizza_attr.attivo == 'true'?'selected':''} >Vero</option>
											<option value="false" ${edit_pizza_attr.attivo == 'false'?'selected':''} >Falso</option>
										</select>
									</spring:bind>
